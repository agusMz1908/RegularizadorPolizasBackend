...
namespace RegularizadorPolizas.Infrastructure.Migrations
{
    ...
    [Migration("20250620173813_AddModeToApiKeys")]
    partial class AddModeToApiKeys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Action = "Read",
                            CreatedAt = new DateTime(2025, 6, 20, 17, 38, 12, 345, DateTimeKind.Utc).AddTicks(6087),
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTime(2025, 6, 20, 17, 38, 12, 345, DateTimeKind.Utc).AddTicks(6087)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            GrantedAt = new DateTime(2025, 6, 20, 17, 38, 12, 345, DateTimeKind.Utc).AddTicks(6087),
                            IsActive = true,
                            PermissionId = 1,
                            RoleId = 1
                        },
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AssignedAt = new DateTime(2025, 6, 20, 17, 38, 12, 345, DateTimeKind.Utc).AddTicks(6087),
                            IsActive = true,
                            RoleId = 1,
                            UserId = 1
                        });
