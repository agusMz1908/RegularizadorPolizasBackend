...
namespace RegularizadorPolizas.Infrastructure.Migrations
{
    ...
    [Migration("20250714193737_AddProcessDocumentCompanyRelationAndIndexes")]
    partial class AddProcessDocumentCompanyRelationAndIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Action = "Read",
                            CreatedAt = new DateTime(2025, 7, 14, 19, 37, 35, 784, DateTimeKind.Utc).AddTicks(508),
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.PolizaVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CamposVerificados")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PolizaId", "EstadoGeneral")
                        .HasDatabaseName("IX_PolizaVerifications_PolizaId_Estado");

                    b.ToTable("PolizaVerifications", (string)null);
                });
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.ProcessDocument", b =>
                {
                    ...
                    b.Property<string>("CodigoCompania")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)");
                    ...
                    b.Property<decimal?>("CostoProcessamiento")
                        .HasColumnType("decimal(10,4)");

                    b.Property<bool?>("EnviadoVelneo")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<DateTime?>("FechaEnvioVelneo")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<string>("RespuestaVelneo")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");
                    ...
                    b.Property<decimal?>("TiempoProcessamiento")
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTime(2025, 7, 14, 19, 37, 35, 784, DateTimeKind.Utc).AddTicks(508)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            GrantedAt = new DateTime(2025, 7, 14, 19, 37, 35, 784, DateTimeKind.Utc).AddTicks(508),
                            IsActive = true,
                            PermissionId = 1,
                            RoleId = 1
                        },
            ...
            modelBuilder.Entity("RegularizadorPolizas.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AssignedAt = new DateTime(2025, 7, 14, 19, 37, 35, 784, DateTimeKind.Utc).AddTicks(508),
                            IsActive = true,
                            RoleId = 1,
                            UserId = 1
                        });
