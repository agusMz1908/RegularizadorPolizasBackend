...
public class DocumentResultParser
{
    ...
    /// <summary>
    /// Convierte un DocumentResultDto (resultado de procesamiento) a PolizaDto
    /// Este método maneja los datos extraídos como Dictionary<string, string>
    /// </summary>
    ...
    #region Mapeo desde DocumentResultDto (Dictionary)
